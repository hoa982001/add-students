...
const Table = (props) => {
  ...
  return <div className= 'container'>
      ...
      <tbody>
        {props.dataTableContent.map((x, index) => (
          <tr>
            ...
            <td>{x.hobby}</td>
            <td>
            <button onClick={() =>dispatch({ type: 'DELETE_PERSON', payload: x.id })}>delete</button></td>
            <td>
              <input type="button" value='edit' onClick={() => clickEdit(x)} />
            </td>
          </tr>
        ))}
      </tbody>
    ...
    <div className="list-edit">
      ...
      <input type="button" value='edit' onClick={submitEdit} />
    </div>
  </div>
}
